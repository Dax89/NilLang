...
NIL_EXPORT void nil_reset(Nil* self);
...
NIL_EXPORT bool nil_disasmfile(Nil* self, const char* filepath);
NIL_EXPORT bool nil_disasmstring(Nil* self, const char* source);
